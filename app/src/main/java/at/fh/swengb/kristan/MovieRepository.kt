...
object MovieRepository {
    ...
    fun rateMovie(movieId: String, rating: Review, success: (movie: Unit) -> Unit, error: (errorMessage: String) -> Unit){
        MovieApi.retrofitService.rateMovie(movieId, rating).enqueue(object: Callback<Unit> {
